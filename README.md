...
[![Platform](https://img.shields.io/badge/Platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey.svg)](sci_calc_gui.py)

A modern, dark-themed **graphical scientific calculator application** built in Python with **Tkinter**.  
...
- **Angle Modes**: Toggle seamlessly between **DEG** (Degrees) and **RAD** (Radians) for trigonometric calculations.
...
├── test_sci_calc.py   # Automated unit test suite
...
### Prerequisites
- Python 3.8 or higher installed (Tkinter comes pre-installed with standard Python distributions).
